...
*/
  ...
  return (
    <div
      ...
      className="flex flex-col justify-between border border-gray-100/10 rounded-md px-6 py-6 bg-v9-secondary-black transition-colors"
    >
      <div>
        <div className="flex items-center justify-between">
          {props.year ?<div className="text-v9-pink">{props.year}</div>:null}
          {props.stars ? (
        ...
        <div className=" text-v9-light-grey font-light mt-2" dangerouslySetInnerHTML={{__html: props.tagline }}>
        </div>
      </div>
      <div>
        ...
        <div className="flex items-center mt-4">
          {props.github_url && (
            ...
            >
              <span data-cursor={`view-project-button}`} className="mr-2">
                View Project
              </span>
              <svg
                data-cursor={`view-project-button`}
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width={'14px'}
                height={'14px'}
          ...
          {props.demo_url && (
            <Button
              ...
              className="mx-1 flex-1"
              id={`demo-project-button`}
            >
              <span data-cursor={`demo-project-button`} className="mr-2">
                Demo
              </span>
              <svg
                data-cursor={`demo-project-button`}
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width={'14px'}
                height={'14px'}
